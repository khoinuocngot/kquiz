...
- Google Publisher Tag - Google Ad Manager web banner and rewarded ads integration.
- Google AdSense - Google-served web ads and site verification script.

The app does not embed private AI keys. AI Pro requires a user-configured proxy endpoint.
Banner and rewarded ads require user-configured Google Ad Manager ad unit paths or an approved AdSense site; no ad account secret is stored in this frontend.
